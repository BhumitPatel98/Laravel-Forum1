                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        @auth
                            ...
                            <a href="{{ route('discussions.create') }}" style="width: 100%" class="btn btn-info mb-2">
                                Add Discussion
                            </a>
                            
                        @else

                            <a href="{{ route('login') }}" style="width: 100%" class="btn btn-success mb-2">
                                Sig in to Add Discussion
                            </a>
